...
The goal of this project is to define an exam scheduling problem as a CSP problem, in timetable.py, and then use the implemented algorithms from csp.py to analyze the results and come to a conclusion about the best performing algorithm. 
